...
class AE_with_imputation_ML_100k():

    def __init__(self, num_user, num_item, train, test, output, n_hidden, **params):
        super(AE_with_imputation_ML_100k, self).__init__()
    ...
    def preTrain(self, iterations=200, batch_size=943):
        ...
        for i in range(self._num_user) :
            ...
            constrain = sorted_missing[int(round(self._num_item *0.02 ))]
...
def example():
    ...
    mf_model = AE_with_imputation_ML_100k(
